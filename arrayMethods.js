...
(function(){
    for(var i = 8; i>2; i--){
        upToTen.splice(2,0,i);
    }
})();

(function(){
    for(var i = brownOnly.length; i>0; i--){
        if(brownOnly[i] !== "brown"){
            brownOnly.splice(i,1);
        }
    }
...
var updatedOrders = orderQueue.concat({takeOut: "pho"},{takeOut: "sushi"});
