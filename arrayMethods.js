...
// do your work below!
var nameArray = [];
nameArray.push('Andrew', 'Peterson');

var numberArray = genericNumberArray.push(6, 7, 8, 9, 10);

var popResult = colors.pop();

var unscramble = scrambledWords.reverse();

var newphonenumber = phoneNumber.reverse();

var nextOrder = orderQueue.shift();

var orderedNumbers = mixedNums.sort();
...
var addupToTen = upToTen.splice(2, 1, 3, 4, 5, 6, 7, 8, 9);

var newbrown = brownOnly.splice(1, 5, 'brown', 'brown', 'brown');

var orderedValuesNewLength = orderedValues.unshift(1, 2, 3);

var randomThingsArray = genericNumberArray.concat(colors);

var myOrder = [{takeOut: 'Ice Cream'}, { takeOut: 'Burger'}];
